...
def delete_query(user_id, q_id):
    # Insert a new number into the 'numbers' table.
    db.execute("DELETE FROM public.practice WHERE question_id = {} and user_id = {}".format(q_id, user_id))
    db.execute("DELETE FROM public.questions WHERE id = {} and user_id = {}".format(q_id, user_id))
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if command == "tag":
        ...
        reply_markup = InlineKeyboardMarkup(keyboard)
        print('___________________________Выбран вопрос id:{}_________________________'.format(question[0][0]))
        ...
        keyboard = [
            ...
            InlineKeyboardButton("😔Hard", callback_data="answer_{}_{}_{}_1".format(q_tag, q_id, q_level)),
            InlineKeyboardButton("🤷‍♂️Good", callback_data="answer_{}_{}_{}_2".format(q_tag, q_id, q_level)),
